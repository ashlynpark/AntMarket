...
const Button = ({style, textStyle, disabled, label, onPress, renderIcon}: ButtonProps) => {
    const bgColor = style?.hasOwnProperty('backgroundColor') ? style.backgroundColor : '#194260';

    return (
        <TouchableOpacity style={[styles.button, style, {backgroundColor: disabled ? '#8e9399' : bgColor}]} >
