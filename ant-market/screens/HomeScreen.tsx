...
const buttonBg =
  "https://images.footballfanatics.com/uc-irvine-anteaters/uc-irvine-anteaters-custom-mascot-5-ast_ss10_p-101152583+u-sjlqljlyfh5j7h33lcpm+v-z7fmvxdc5ef0uytjnjc3.jpg?_hv=2&w=900";
    ...
    <Screen preset="scroll">
      ...
      <SafeAreaView>
        <View>
          ...
          <View>
            <Tags
              tags={["furniture", "textbook", "vintage", "sofa", "shirt"]}
            />
          </View>
          <TouchableOpacity
            style={styles.postButt}
            onPress={() => navigation.navigate("Swipe Deck")}
          >
            <ImageBackground
              source={require("../assets/anteaterplush_tiny.png")}
              resizeMode="repeat"
            >
              <View
                style={{
      ...
      {props.categories.map((item, index) => {
        return (
          <TouchableOpacity
            ...
            onPress={() => {
              navigation.navigate("Search Results2");
            }}
          >
            <View style={{ flex: 1 }}>
