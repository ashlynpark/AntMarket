...
const savedListings = [
  {
    ...
    image:
      "https://d6qwfb5pdou4u.cloudfront.net/product-images/6640001-6650000/6644132/7ae2465679cb87a90b5a5b5847d3a6a6d822fcb474177ddafa13e19219794d64/500-500-crop-0.jpg",
    seller: "howard_g",
    price: 50,
  },
  {
    ...
    image:
      "https://images.urbndata.com/is/image/FreePeople/78468865_010_m/?$a15-pdp-detail-shot$&fit=constrain&qlt=80&wid=640",
    seller: "beach_gurl29",
    price: 0,
  },
  {
    ...
    image:
      "https://cdn.shopify.com/s/files/1/0009/0839/4551/products/CIR-CREW-001_a7753bad-98b1-4d6f-a276-145f27a7c335_1400x.png?v=1668527510",
  ...
  },
  {
    ...
    location: "Irvine, California",
    image:
      "https://cdn.shopify.com/s/files/1/0305/7700/0584/products/232-ROSIE_Pink_Vintage_Armchair.jpg?v=1581605997",
    seller: "haha69",
    price: 0,
  },
];
    ...
    >
      <View style={styles.profileContainer}>
        <Image
          ...
          source={require("../assets/uci.png")}
        />
      </View>
      <View style={{ padding: "2%" }}>
        <Text style={styles.username}>petr-anteatr</Text>
        <StarRating
          rating={4.5}
          onChange={() => {}}
          starSize={24}
          color="#454745"
          starStyle={{ marginHorizontal: 1, marginTop: "7%" }}
        />
        <Text style={[styles.regularText, { paddingLeft: 3 }]}>6 reviews</Text>
      </View>
  ...
  return (
    <TouchableOpacity style={styles.messageCard}>
      ...
      <View style={{ flex: 3, justifyContent: "space-between", padding: "3%" }}>
        ...
        <Text style={styles.messageBody} numberOfLines={2} ellipsizeMode="tail">
