    ...
    <Screen preset="scroll">
      ...
      <View style={styles.titleContainer}>
        ...
        <Text
          style={[
            styles.titleText,
            { flex: 1, textAlign: "right", fontFamily: "OpenSans_600SemiBold" },
          ]}
        >
...
const Tags = (props: { tags: string[] }) => {
  return (
    <View
      style={{ alignSelf: "flex-end", marginTop: "10%", flexDirection: "row" }}
    >
      {props.tags.map((item, index) => {
        return (
          <View key={index} style={styles.singleTag}>
            <Text
              style={[
                { fontFamily: "OpenSans_300Light", fontSize: 12, margin: "3%" },
              ]}
            >
              #{item}
            </Text>
